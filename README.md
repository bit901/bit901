    ...
    <div class="main-content">
      ...
      <section id="hero" class="mb-16">
        <div class="hero-overlay rounded-2xl p-6 md:p-12 mb-8">
          <div class="bento-grid flex gap-6 items-center">
            <div class="flex-1">
              <img src="https://kimi-img.moonshot.cn/pub/icon/spinner.svg" alt="Phoenix desert sunset landscape" class="w-full h-80 object-cover rounded-xl shadow-lg" size="large" aspect="wide" style="photo" query="phoenix desert sunset landscape" referrerpolicy="no-referrer" />
            </div>
            <div class="flex-1">
              <div class="mb-6">
      ...
      <section id="community" class="mb-16">
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-8">
          <div>
            <img src="https://kimi-img.moonshot.cn/pub/icon/spinner.svg" alt="Phoenix underground electronic music event with desert-inspired lighting" class="w-full h-64 object-cover rounded-xl shadow-lg mb-6" size="medium" aspect="wide" style="photo" query="Phoenix underground electronic music event" referrerpolicy="no-referrer" />
          </div>
          <div>
            <div class="space-y-6">
              <div>
